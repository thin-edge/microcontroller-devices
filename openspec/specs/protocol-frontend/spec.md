...
Define the shared device data model owned by the common core and the uniform contract that every protocol frontend library conforms to, including the OPC-UA frontend.
