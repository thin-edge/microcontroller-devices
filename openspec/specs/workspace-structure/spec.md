...
Define the layered, single-manifest workspace layout that separates a shared core, per-protocol libraries, and per-protocol applications, along with how they are composed and built.
## Requirements
