# modbus-tcp-server Specification

## Purpose

Define the Modbus TCP server frontend: a raw-ADU server on TCP port 502 that maps the shared device data model onto the four Modbus object types and conforms to the protocol-frontend contract.
