# tedge-device-state Specification

## Purpose
What the device tells the cloud about itself: inventory and supported operations, restart through the application's hooks, and state published as twin and health messages that a gateway or a Smart Function can map.
