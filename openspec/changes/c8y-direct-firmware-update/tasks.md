...
- [ ] 3.1 Unit tests: URL parsing and the redirect rules, the token-domain rule (tenant host, tenant-ID host, a foreign host), the `515` fields, and the progress payload
