...
In provisioning mode the device SHALL act as a BLE peripheral implementing the
Improv Wi-Fi BLE service (UUID `00467768-6228-2272-4663-277478268000`) with its
