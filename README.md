...
|---|---|---|---|---|
| ESP32-C6-DevKitC-1 (N4) | `esp32c6_devkitc/esp32c6/hpcore` | `modbus-server`, `opcua-server`, `snmp-agent` | `modbus-server` | — |
| ESP32-S3-DevKitC-1 (N16R8) | `esp32s3_devkitc/esp32s3/procpu` | `modbus-server`, `opcua-server`, `snmp-agent` | `modbus-server` | — |
| Adafruit QT Py ESP32-S3 (N4R2) | `adafruit_qt_py_esp32s3/esp32s3/procpu` | `modbus-server`, `opcua-server`, `snmp-agent` | `modbus-server` | — |
| ESP32-WROOM-32 DevKitC | `esp32_devkitc/esp32/procpu` | `modbus-server`, `opcua-server`, `snmp-agent` | — | `modbus-server`, `tedge-agent` |
| ESP32-CAM (ESP32 + 4 MB PSRAM) | `esp32_devkitc/esp32/procpu` | — | — | `snmp-agent` |
<!-- devices:end -->
